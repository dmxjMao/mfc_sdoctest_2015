// DockPane2.cpp : implementation file
//
...
CDockPane2::CDockPane2()
{
	m_nCurrSort = ID_SORTING_SORTALPHABETICALY;
}
...
BEGIN_MESSAGE_MAP(CDockPane2, CDockablePane)
	ON_WM_CREATE()
	ON_WM_SIZE()
END_MESSAGE_MAP()
...
// CDockPane2 message handlers




int CDockPane2::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_ClassViewImages.Create(IDB_CLASS_VIEW_24, 16, 0, RGB(255, 0, 0));
...
void CDockPane2::OnSize(UINT nType, int cx, int cy)
{
